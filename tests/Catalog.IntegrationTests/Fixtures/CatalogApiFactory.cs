...
public sealed class CatalogApiFactory(CatalogInfrastructureFixture fixture) : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        var tempKeyPath = Path.Combine(Path.GetTempPath(), "mediaforge_test_catalog_public.pem");
        ...
        builder.ConfigureAppConfiguration((_, config) =>
        {
            ...
            {
                ["ConnectionStrings:CatalogDb"] = fixture.PostgresConnectionString,
        ...
        builder.ConfigureServices(services =>
        {
            ...
            // Accept any bearer token signature - Catalog validates against a real RSA
    ...
    public HttpClient CreateAuthenticatedClient(Guid userId, string role = "creator")
    {
